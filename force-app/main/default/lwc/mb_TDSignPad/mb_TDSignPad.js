...
export default class sdp_VehicleDeliveryCertificate_SignPad extends LightningElement {
    ...
    toDataUrl() {
        ...
        this.dispatchEvent(new CustomEvent('signurl', { detail: { 'dataURL': dataUrl, 'isEmpty': this._isEmpty }, bubbles: true, composed: true}));
        // This event for Parent Aura cmp
        this.dispatchEvent(new CustomEvent('signurlaura', { detail: { 'dataURL' : dataUrl }}));
    }
